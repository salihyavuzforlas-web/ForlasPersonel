...
import { Edit2, Paperclip, CheckSquare, Square, CreditCard, ChevronDown, ChevronUp, X } from 'lucide-react';
...
const ExpenseList: React.FC<ExpenseListProps> = ({ expenses, onEdit, selectable, onSelectionChange }) => {
