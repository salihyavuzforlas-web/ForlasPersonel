                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-4" onClick={(e) => e.stopPropagation()}>
                              {expense.receiptData ? (
                                <button
                                  onClick={() => openAttachment(expense)}
                        ...
                        >
                          ...
                          <div className="flex gap-2 justify-end border-t border-slate-100 pt-3">
                            {expense.receiptData && (
                              <button
                                onClick={() => openAttachment(expense)}
                                className="py-2.5 px-4 bg-white border border-red-100 text-red-600 rounded-xl text-[9px] font-black uppercase shadow-sm flex items-center justify-center gap-1.5"
                              >
                                <Paperclip size={12} /> BELGE
                              </button>
                            )}
                            {expense.status === ExpenseStatus.SUBMITTED && (
                              <>
